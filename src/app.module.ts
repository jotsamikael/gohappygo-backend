  ...
  imports: [
    ...
    ConfigModule.forRoot({
      ...
      validationSchema: joi.object({
        ...
        STRIPE_RETURN_URL_WEB: joi.string().uri().optional(),
        STRIPE_REFRESH_URL_WEB: joi.string().uri().optional(),
        ...
        PLACEHOLDER_IMAGE_URL: joi.string().uri().optional(),
        DIDIT_API_KEY: joi.string().optional(),
        DIDIT_BASE_URL: joi.string().uri().optional(),
        DIDIT_WEBHOOK_SECRET_KEY: joi.string().optional(),
        DIDIT_WORKFLOW_ID: joi.string().optional(),
        KYC_RETURN_URL: joi.string().uri().optional(),
        KYC_RETURN_URL_WEB: joi.string().uri().optional(),
        KYC_RETURN_URL_MOBILE: joi.string().uri().optional(),
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        extra: {
          ...
          timeout: 60000,
          //reconnect: true, // No longer supported in mysql2 v3.14.1
          ...
          //reconnectDelay: 1000, //no longer supported in mysql2 v3.14.1
        },
